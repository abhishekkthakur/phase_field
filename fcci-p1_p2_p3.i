...
[Materials]
  [./f1]
    ...
    f_name = F1
    args = 'xu xnd xas'
    #function = #'xu*-57515.479353 + xnd*5000 + xas*5000 + 3*xas*xas*-1.44 + 3*xnd*xnd*2.6 + 3*xnd*xas*-3.225
    function =   '8.314*300*(xu*log(xu) + xnd*log(xnd) + xas*log(xas))'
  ...
  [./f2]
    ...
    function =  '0.5*8.314*300*(2*xu*log(2*xu) + (1-2*xu)*log(1-2*xu))'
                #+ xu*xnd*0.51 + xu*xas*6.76 + xnd*xas*16.65'
  [../]
  [./f3]
    type = DerivativeParsedMaterial
    f_name = F3
    args = 'xu xnd xas'
    function = '1000' #+ xnd*5000 + xas*1000'
